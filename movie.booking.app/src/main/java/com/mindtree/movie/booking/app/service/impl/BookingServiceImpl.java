...
public class BookingServiceImpl implements BookingService {
	...
	public Object bookTickets(@Valid Long userId, @Valid long screeningId, @Valid int ticketsQuentity) {
		...
		logger.info("BookingServiceImpl - bookTickets", "user", user.getUserName());
		
		Screening scr = scrRepo.findById(screeningId)
				.orElseThrow(() -> new ResourceNotFoundException("Screening", "screeningId", screeningId));

		logger.info("BookingServiceImpl - bookTickets", "Screening", scr.getStartTime());
		...
		logger.info("BookingServiceImpl - bookTickets", "booking", booking.getBookingTime());
	...
	public Object getBookingDetails(Long userId) {
		...
		logger.info("BookingServiceImpl - getBookingDetails", "user", user.getUserName());
